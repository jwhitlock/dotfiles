...
vim.keymap.set('n', '<leader>dn', vim.diagnostic.goto_next, { silent = true, desc = "Go to next diagnostic"})
vim.keymap.set('n', '<leader>dp', vim.diagnostic.goto_prev, { silent = true, desc = "Go to previous diagnostic"})
vim.keymap.set('n', '<leader>dl', "<cmd>Telescope diagnostics<cr>", { silent=true, desc = "List diagnostics"})
